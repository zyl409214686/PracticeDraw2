...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第三处：DashPathEffect
        PathEffect dashPathEffect = new DashPathEffect(new float[]{10, 20, 5, 1}, 0);
        ...
        p.rLineTo(30, -30);
        p.rLineTo(-30, 0);
        PathEffect pathDashEffect = new PathDashPathEffect(p, 50, 0, PathDashPathEffect.Style.ROTATE);
