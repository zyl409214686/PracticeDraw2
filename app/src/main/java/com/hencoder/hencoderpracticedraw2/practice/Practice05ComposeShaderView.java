...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Shader shaderLogo = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo),
                Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader composeShader = new ComposeShader(shaderBatMan, shaderLogo, PorterDuff.Mode.DST_IN);
        paint.setShader(composeShader);
        canvas.drawCircle(200, 250, 250, paint);
    }
}
